...
define('APPPATH', realpath(DOCROOT . '3.3/application') . DIRECTORY_SEPARATOR);
define('MODPATH', realpath(DOCROOT . '3.3/modules') . DIRECTORY_SEPARATOR);
define('SYSPATH', realpath(DOCROOT . '3.3/system') . DIRECTORY_SEPARATOR);
