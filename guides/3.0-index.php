...
define('APPPATH', realpath(DOCROOT . '3.0/application') . DIRECTORY_SEPARATOR);
define('MODPATH', realpath(DOCROOT . '3.0/modules') . DIRECTORY_SEPARATOR);
define('SYSPATH', realpath(DOCROOT . '3.0/system') . DIRECTORY_SEPARATOR);
