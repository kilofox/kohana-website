...
define('APPPATH', realpath(DOCROOT . '3.4/application') . DIRECTORY_SEPARATOR);
define('MODPATH', realpath(DOCROOT . '3.4/modules') . DIRECTORY_SEPARATOR);
define('SYSPATH', realpath(DOCROOT . '3.4/system') . DIRECTORY_SEPARATOR);
