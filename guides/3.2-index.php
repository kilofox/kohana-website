...
define('APPPATH', realpath(DOCROOT . '3.2/application') . DIRECTORY_SEPARATOR);
define('MODPATH', realpath(DOCROOT . '3.2/modules') . DIRECTORY_SEPARATOR);
define('SYSPATH', realpath(DOCROOT . '3.2/system') . DIRECTORY_SEPARATOR);
