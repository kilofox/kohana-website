...
define('APPPATH', realpath(DOCROOT . '../guides/3.3/application') . DIRECTORY_SEPARATOR);
define('MODPATH', realpath(DOCROOT . '../guides/3.3/modules') . DIRECTORY_SEPARATOR);
define('SYSPATH', realpath(DOCROOT . '../guides/3.3/system') . DIRECTORY_SEPARATOR);
