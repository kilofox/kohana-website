...
define('APPPATH', realpath(DOCROOT . '../guides/3.5/application') . DIRECTORY_SEPARATOR);
define('MODPATH', realpath(DOCROOT . '../guides/3.5/modules') . DIRECTORY_SEPARATOR);
define('SYSPATH', realpath(DOCROOT . '../guides/3.5/system') . DIRECTORY_SEPARATOR);
...
require '../guides/3.5-bootstrap.php';
