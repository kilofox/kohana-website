...
define('APPPATH', realpath(DOCROOT . '../guides/3.1/application') . DIRECTORY_SEPARATOR);
define('MODPATH', realpath(DOCROOT . '../guides/3.1/modules') . DIRECTORY_SEPARATOR);
define('SYSPATH', realpath(DOCROOT . '../guides/3.1/system') . DIRECTORY_SEPARATOR);
